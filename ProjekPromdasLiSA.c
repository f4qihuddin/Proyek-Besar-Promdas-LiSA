...
int main()
{
    ...
    int opsi, opsi2, opsi3, opsi4, opsi5, opsi6, nomorTugas, inputTanggal, inputTahun, signInBerhasil = 0, keMenuUtama = 1, menuLisa = 0, menuFilter = 0, menuStatus = 0, menuDeadline = 0;
                ...
                if (opsi2 == 1)
                {
                    while (menuLisa == 0)
                    {
                        ...
                        while (konfirmasi == 'y')
                        {
                            ...
                            printf("Ingin Membuat Daftar Tugas Lagi (y/t)? ");
                            scanf(" %c", &konfirmasi);
                        }
